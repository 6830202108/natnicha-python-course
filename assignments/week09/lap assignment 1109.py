...
ค่าไฟฟ้าขึ้นกับจำนวนการใช้งาน
จำนวนหน่วย        อัตราต่อหน่วย
1-50 หน่วย        2.50 บาท
...
เงื่อนไข
    ...
    ให้แสดงรายละเอียดค่าไฟแต่ละช่วงพร้อมรวมสุทธิ
...
def calculate_electricity_cost(units):
    ...
    if units > 200:
        ...
        print(f"101-200 หน่วย: {(units - 100) * 3.50} บาท")
        print(f"201-{units} หน่วย: {(units - 200) * 4.00} บาท")
        print(f"ค่าบริการ: 25.00 บาท")
        print(f"รวมค่าไฟทั้งสิ้น: {cost}")
